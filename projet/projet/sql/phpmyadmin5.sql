...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 01 avr. 2024 à 23:03
...
INSERT INTO `avis` (`Id_avis`, `Note`, `description`, `Jour`, `ID_user`, `ID_offre`) VALUES
(3, 1.00, 'Trop des lol', '2024-01-04', 1, 1),
(5, 5.00, 'MEILLEURE ENTREPRISE DU MONDE SVP UNE PRIME', '2024-01-04', 7, 1);
...
INSERT INTO `candidature` (`ID_Candi`, `ID_offre`, `ID_user`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 2),
...
(2, 'Cesi', 'Finance', '5 Avenue des Finances', '', '', 1, 'src/logo/Cesi.png'),
(3, 'CHU', 'Santé', '10 Boulevard de la Santé', '', '', 0, 'src/logo/CHU.jpg'),
...
(1, 'Développeur Web', 'HTML, CSS, JavaScript', 'Propulsez votre présence en ligne avec notre expertise en développement web. Sites sur mesure, UX/UI optimisée, SEO intégré. Transformez votre vision en réalité digitale dès aujourd\'hui.', '1', 6, 1500.00, '2024-04-01', 0, 1, 0, 2),
...
(9, 'Chef de projet', 'BTP', 'Porbleme incoming\r\n                        ', '3', 5, 1970.00, '0000-00-00', 1, 1, 1, 4);
...
('root', '[{\"db\":\"phpmyadmin\",\"table\":\"avis\"},{\"db\":\"phpmyadmin\",\"table\":\"stage\"},{\"db\":\"phpmyadmin\",\"table\":\"wishlist\"},{\"db\":\"phpmyadmin\",\"table\":\"offre\"},{\"db\":\"phpmyadmin\",\"table\":\"integrer\"},{\"db\":\"phpmyadmin\",\"table\":\"entreprise\"},{\"db\":\"phpmyadmin\",\"table\":\"candidature\"},{\"db\":\"phpmyadmin\",\"table\":\"admin\"},{\"db\":\"phpmyadmin\",\"table\":\"utilisateur\"},{\"db\":\"phpmyadmin\",\"table\":\"promotion\"}]');
...
('root', '2024-04-01 19:53:55', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
...
INSERT INTO `stage` (`ID_Stage`, `ID_Candi`, `ID_user`) VALUES
(1, 1, 1),
(2, 5, 1),
(5, 3, 3);
...
--
ALTER TABLE `candidature`
  MODIFY `ID_Candi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
ALTER TABLE `avis`
  ...
  ADD CONSTRAINT `avis_ibfk_2` FOREIGN KEY (`ID_offre`) REFERENCES `offre` (`ID_offre`);
...
--
ALTER TABLE `stage`
  ADD CONSTRAINT `stage_ibfk_1` FOREIGN KEY (`ID_Candi`) REFERENCES `candidature` (`ID_Candi`),
  ADD CONSTRAINT `stage_ibfk_2` FOREIGN KEY (`ID_user`) REFERENCES `utilisateur` (`ID_user`);
