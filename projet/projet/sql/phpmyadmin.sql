...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 31 mars 2024 à 13:03
...
CREATE TABLE `entreprise` (
  ...
  `Note_avis` decimal(15,2) DEFAULT NULL,
  `Stat_postule` int(11) DEFAULT NULL,
...
INSERT INTO `entreprise` (`ID_entreprise`, `Nom`, `secteur_d_activité`, `Adresse`, `Adresse_2`, `Adresse_3`, `Note_avis`, `Stat_postule`, `Voir`, `logo`) VALUES
(1, 'Microsoft', 'Technologie', '1 Rue de la Techno', NULL, NULL, 4.50, 18, 1, 'logo_entreprise_a.png'),
(2, 'Cesi', 'Finance', '5 Avenue des Finances', '', '', 3.80, 1, 0, 'src/logo/Cesi.png'),
(3, 'CHU', 'Santé', '10 Boulevard de la Santé', '', '', 4.20, 14, 1, 'src/logo/CHU.png'),
(4, 'Capgemini', 'Informatique', 'Lille, rue massena', 'Paris la defense', '', 0.00, 0, 1, 'src/logo/Capgemini.jpg');
...
(1, 'Développeur Web', 'HTML, CSS, JavaScript', 'Propulsez votre présence en ligne avec notre expertise en développement web. Sites sur mesure, UX/UI optimisée, SEO intégré. Transformez votre vision en réalité digitale dès aujourd\'hui.', '1', 6, 1500.00, '2024-04-01', 5, 1, 1, 1),
...
('root', '2024-03-31 10:56:54', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
...
(1, 'Dupont', 'Jean', 'jean.dupont', 'motdepasse1', 'Lille', 1, 'cv_jean_dupont.pdf', NULL),
...
(10, 'Hertz', 'Erwan', 'Erwan.hertz', 'Pudat7896', 'Lille', 1, NULL, NULL),
